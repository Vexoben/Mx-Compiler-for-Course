...
@b = dso_local global [100 x [100 x [100 x i32]]] zeroinitializer, align 16
...
define dso_local i32 @main(i32 %0) #4 {
  ...
  %10 = call i8* @_Znam(i64 %9) #7
  %11 = bitcast i8* %10 to i32**
  store i32** %11, i32*** %3, align 8
  store i32 10, i32* getelementptr inbounds ([100 x [100 x [100 x i32]]], [100 x [100 x [100 x i32]]]* @b, i64 0, i64 1, i64 2, i64 3), align 4
  ret i32 0
}
