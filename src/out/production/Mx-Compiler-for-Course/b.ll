...
@tmp = dso_local global %class.foo zeroinitializer, align 4
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  call void @_ZN3fooC2Ev(%class.foo* @tmp)
  ret void
}
...
define dso_local i32 @main(i32 %0) #5 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  store i32 %3, i32* getelementptr inbounds (%class.foo, %class.foo* @tmp, i32 0, i32 0), align 4
  %4 = load i32, i32* getelementptr inbounds (%class.foo, %class.foo* @tmp, i32 0, i32 0), align 4
